...
export const importanceOfPromptingScripts: ScriptInterface[] = [
  {
    id: 1,
    concept: "AI에게 내가 원하는걸 '<strong>명확하게</strong>' 전달하는 말",
    script: '이게 바로 프롬프팅이야.',
    voice: '1-3_Development_1.mp3',
    maiPng: '1-3/pointMai.png',
  },
  {
    id: 2,
    concept: "AI에게 내가 원하는걸 '<strong>명확하게</strong>' 전달하는 말",
    script: "AI한테 '그림 그려줘'라고 하는 게 아니라,\n'내가 본 세상'을 말로 전달하는 과정.",
  ...
  },
  {
    id: 3,
    concept: "AI에게 내가 원하는걸 '<strong>명확하게</strong>' 전달하는 말",
    script: "AI에게 내가 원하는 걸 '명확하게' 전달하는 말\n그 차이 하나로 결과가 완전히 달라지지.",
  ...
  },
  {
    id: 5,
    concept: "AI에게 내가 원하는걸 '<strong>명확하게</strong>' 전달하는 말",
    script: '파란 하늘 아래 노란 해바라기가 있는\n그림을 그려줘라고 말하면 훨씬 더 잘 알아듣겠지?',
  ...
  },
  {
    id: 8,
    concept: "AI에게 내가 원하는걸 '<strong>명확하게</strong>' 전달하는 말",
    script: '그래서 어떤 단어를 넣느냐,\n어떤 순서로 말하느냐에 따라서 결과가 완전 달라져.',
