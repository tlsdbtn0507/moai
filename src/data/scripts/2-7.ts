...
export const practiceScripts: PracticeScript[] = [
    ...
    {
        id: 2,
        script: '우선 AI가 잘 대답할 수 있는 질문을 만들어보고,\n답변을 검증해볼거야!',
        maiPic: '2-7/presentHoldingMai.png',
        isSpeechBubbleBig: true,
        chatPng: null,
        voiceUrl: '2-7/2-7_practice_2N.mp3',
    },
    {
        id: 3,
    ...
    },
    {
        ...
        isSpeechBubbleBig: true,
        chatPng: null,
        voiceUrl: '2-7/2-7_practice_6N.mp3',
    },
    {
        id: 7,
    ...
    {
        id: 9,
        script: '그럼 이제 AI가 조건에 맞게\n대답을 잘 하였는지 답변을 검증해보자!',
        maiPic: '2-7/presentHoldingMai.png',
        isSpeechBubbleBig: true,
        chatPng: null,
    ...
    {
        id: 12,
        script: '만약 AI가 대답에서 조건을 누락하였다면\n빠진 조건을 포함해서 다시 대답해달라고\n요청해야해',
        maiPic: '2-7/presentHoldingMai.png',
        isSpeechBubbleBig: true,
        chatPng: null,
        voiceUrl: '2-7/2-7_practice_12N.mp3',
    },
    {
        id: 13,
        script: '또한, 출처를 포함할 시에는 반드시\n그 출처가 맞는지, 내용이 옳바른지 확인해야해!',
        maiPic: '2-7/presentHoldingMai.png',
        isSpeechBubbleBig: true,
        chatPng: null,
