...
export const conceptStepScripts : ConceptScriptInterface[] = [
    ...
    },
    {
        ...
        activity: '나만의 AI 비서를 직접 제작해보자 ',
        content: '',
        script: '역할, 기능, 말투, 행동 규칙, 도구 \n같은 요소를 결정하면 <strong>비서가 어떤 방식으로 \n‘생각하고 말하는지’</strong>가 완성되지.',
    ...
    },
    {
        ...
        content: '',
        script: '<strong>역할</strong>은 비서가 <strong>어떤 분야를 담당할지를\n결정</strong>하는 기준이야.',
    ...
    },
    {
        ...
        activity: '역할 — 비서의 전체 방향성',
        content: '',
        script: '비서가 <strong>어떤 문제를 우선적</strong>으로 보고,\n<strong>어떤 방식으로 접근</strong>할지가 여기서 정해져.',
    ...
    },
    {
        ...
        activity: '역할 — 비서의 전체 방향성',
        content: '',
        script: '또한 역할에 따라 비서의 사고 흐름, 답변 깊이,\n정보 처리 <strong>우선순위가 달라</strong>지기도 하지.',
    ...
    },
    {
        ...
        activity: '역할 — 비서의 전체 방향성',
        content: '',
        script: '즉, <strong>전체 성격의 기본 틀</strong>이 되는 단계지.',
    ...
    },
    {
        ...
        activity: '역할 — 비서의 전체 방향성',
        content: '4-2/eaRoles.png',
        script: '그러니까 <strong>너에게 필요한 방향을</strong> 먼저 잡는 게 중요해.',
    ...
    },
    {
        ...
        content: '',
        script: '<strong>기능</strong>은 비서가 직접 <strong>실행하는 행동 단위</strong>야.',
    ...
    },
    {
        ...
        activity: '기능 — 비서가 실제로 수행할 행동',
        content: '',
        script: '설명하기, 정리하기, 계획 만들기처럼 비서가\n<strong>‘어떤 작업을 처리할 수 있는지’</strong>를 정하는 단계지.',
    ...
    },
    {
        ...
        activity: '기능 — 비서가 실제로 수행할 행동',
        content: '',
        script: '역할이 ‘무엇을 할지’를 정했다면,\n기능은 그것을 <strong>‘어떻게 실행할지’</strong>를\n만드는 부분이라고 보면 돼.',
    ...
    },
    {
        ...
        activity: '기능 — 비서가 실제로 수행할 행동',
        content: '4-2/functionMap.png',
        script: '역할이 방향이라면,\n기능은 <strong>구체적인 행동 패턴</strong>이라고 생각하면 돼.',
    ...
    },
    {
        ...
        content: '',
        script: '<strong>말투와 스타일</strong>은 비서가 정보를\n<strong>어떤 분위기로 전달</strong>할지를 결정해.',
    ...
    },
    {
        ...
        activity: '말투·스타일 — 비서의 표현 방식과 성격',
        content: '',
        script: '같은 내용도 말투에 따라 사용자가 느끼는\n<strong>신뢰감, 편안함, 몰입도</strong>가 달라져.',
    ...
    },
    {
        ...
        activity: '말투·스타일 — 비서의 표현 방식과 성격',
        content: '',
        script: '말투는 비서의 성격을 만드는<strong>핵심 요소</strong>야.',
    ...
    },
    {
        ...
        content: '',
        script: '<strong>행동 규칙</strong>은 비서가\n<strong>정보를 정리하는 방식</strong>과 <strong>대화를 진행하는 흐름</strong>을 정해.',
    ...
    },
    {
        ...
        activity: '행동 규칙 — 비서의 사고 흐름(COT)과 반응 방식',
        content: '',
        script: '어떤 정보를 먼저 <strong>선택</strong>할지, 어떤 기준으로 <strong>판단</strong>할지,\n답변을 어떤 구조로 <strong>만들어낼지</strong>가 모두 포함되지.',
    ...
    },
    {
        ...
        activity: '행동 규칙 — 비서의 사고 흐름(COT)과 반응 방식',
        content: '',
        script: '말하자면 비서의 <strong>‘내부 사고 절차’</strong>를\n만드는 단계야.',
    ...
    },
    {
        ...
        activity: '행동 규칙 — 비서의 사고 흐름(COT)과 반응 방식',
        content: '',
        script: '이 <strong>규칙이 안정적</strong>이어야 비서가 상황을 받을 때마다\n<strong>일관된 방식으로 행동</strong>할 수 있어.',
    ...
    },
    {
        ...
        activity: '행동 규칙 — 비서의 사고 흐름(COT)과 반응 방식',
        content: '4-2/eaCOT.png',
        script: '이 규칙들은 비서가 이상한 행동을 하지 않도록\n잡아주는 <strong>안전장치 역할</strong>을 하기도 해.',
    ...
    },
    {
        ...
        content: '',
        script: '<strong>도구</strong>는 비서가 특정 상황을 해결할 때\n추가로 사용할 수 있는 <strong>능력 모듈</strong>이야.',
    ...
    },
    {
        ...
        activity: '도구 설정 — 비서가 사용할 능력 모듈',
        content: '',
        script: '역할과 기능이 비서의 기본 틀이라면,\n도구는 그 틀을 확장해서 <strong>‘더 똑똑하게’</strong> 만들어주는\n옵션이라고 생각하면 돼.',
